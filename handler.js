...
import tacoABI from "./abi/tacoToken.json";
import BigNumber from "bignumber.js";

const web3 = new Web3(process.env.Provider);
const contract = new web3.eth.Contract(tacoABI, process.env.TacoAddress);

export async function getTotalSupply() {
  try {
    const totalSupply = await contract.methods.totalSupply().call();
    const burnt = await contract.methods
      .balanceOf(process.env.BurnAddress)
      .call();
